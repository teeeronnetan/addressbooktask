...
class TaskController extends Controller {
  ...
  void initListeners() {
    ...
    // check task listener
    taskPresenter.checkTaskOnNext = (response) {
      taskPresenter.getAllTask();
    };
    taskPresenter.checkTaskOnComplete = () {};
    taskPresenter.checkTaskOnError = (response) {};
  }
  ...
  void checkTask() {
    _selectedTask.isCheck = true;
    taskPresenter.checkTask(_selectedTask);
  }
